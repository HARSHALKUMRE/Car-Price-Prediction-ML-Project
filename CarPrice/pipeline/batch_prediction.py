...
class BatchPredictionPipeline:
    ...
    """
    logging.info("Prediction Pipeline commences now..")
    logging.info(
    ...
    def initiate(self) -> str:
        ...
        try:
            ...
            logging.info("data fetched as Dataframe successfully!")
            logging.info(f"Shape of the data fetched: {input_df.shape}")
            ...
            logging.info("Readying the prediction file..")
            input_df.to_csv(
            ...
            logging.info(f'Prediction file\'s ready at "{prediction_file_path}"')
            return prediction_file_path
