...
from CarPrice.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from CarPrice.utils.main_utils import load_object
from CarPrice.exception import CarPriceException
from CarPrice.logger import logging
from sklearn.metrics import r2_score
from CarPrice.constant import TARGET_COLUMN
import pandas as pd
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[CarEstimator]:
        """
        ...
        try:
            ...
            car_price_estimator = CarEstimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if car_price_estimator.is_model_present(model_path=model_path):
                return car_price_estimator
            return None
        except Exception as e:
