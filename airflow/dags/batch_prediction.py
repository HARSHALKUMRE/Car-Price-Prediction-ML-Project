...
with DAG(
    ...
    def download_input_files():
        ...
        # Make sure the input dir doest exist
    ...
    def batch_prediction(**kwargs):
        from CarPrice.pipeline.batch_prediction import BatchPredictionPipeline
    ...
    generate_prediction_files = PythonOperator(
        task_id="predict_pipeline", python_callable=batch_prediction)
